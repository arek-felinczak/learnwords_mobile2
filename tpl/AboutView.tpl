<div class='panel panel-default'>
    ...
    <div class="panel-body">
        ...
        <p>
            ...
            - Other with CORS support.
        </p><br />
        <h4> Learnwords is also application for mobile phones</h4>
        <p>
            ...
            <br />Firefox OS is also supported and packages for both platforms will be available soon.
        </p>
    </div>
</div>
